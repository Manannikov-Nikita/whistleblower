...
1. Всегда, когда это возможно - предлагай тесты для вводимых изменений.
2. Каждый диалог и новая фича - отдельная ветка в git
3. Всегда проверяй, что ты не работаешь с веткой master
4. Используй файл CHANGELOG.md для того, чтобы описывать свои изменения для других агентов,
продолжающих работу над проектом.
